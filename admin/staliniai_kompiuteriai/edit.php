...
<body>
    ...
    if (isset($_POST["submit"])) {
        ...
        $sql = "UPDATE staliniai_kompiuteriai SET gamintojas='$gamintojas', kaina='$kaina', procesorius='$procesorius', vaizdo_plokste='$vaizdo_plokste', ram='$ram', hdd='$hdd', papildoma_informacija='$papildoma_informacija' WHERE id='$id'";
