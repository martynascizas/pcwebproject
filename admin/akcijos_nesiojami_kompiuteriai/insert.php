...
if (isset($_FILES['photo']) && $_FILES['photo']['error'] == 0) {
    ...
    if (move_uploaded_file($_FILES['photo']['tmp_name'], $filepath)) {
        ...
        $sql = "INSERT INTO `akcijos_nesiojami_kompiuteriai` (`gamintojas`, `ekrano_istrizaine`, `procesorius`, `vaizdo_plokste`, `ram`, `hdd`, `papildoma_informacija`,`kaina` , `nauja_kaina`, `photo`) VALUES ('$gamintojas', '$ekrano_istrizaine', '$procesorius', '$vaizdo_plokste', '$ram', '$hdd', '$papildoma_informacija', '$kaina', '$nauja_kaina', '$filename')";
