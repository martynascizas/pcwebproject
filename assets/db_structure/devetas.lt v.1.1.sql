...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 28, 2023 at 12:37 AM
...
--
-- Dumping data for table `akcijos_monitoriai`
--

INSERT INTO `akcijos_monitoriai` (`id`, `gamintojas`, `ekrano_istrizaine`, `kaina`, `nauja_kaina`, `photo`, `timestamp`, `rezoliucija`, `lieciamas_ekranas`) VALUES
(11, 'AOC', 27, 300.00, 249.00, '', '2023-08-27 21:47:50', '4K', 'Yes');
...
CREATE TABLE `akcijos_nesiojami_kompiuteriai_photos` (
  `id` int(11) NOT NULL,
  `akcios_nesiojami_kompiuteriai_id` int(11) NOT NULL,
  `filename` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(84, 'AOC', 24, 129.00, '', '2023-08-27 22:26:46', 'FULL HD', 'No');
