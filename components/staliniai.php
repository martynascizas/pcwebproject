    ...
    <div class="wrapper">
        <div class="container products_section mb-5 products-margin">
            ...
            if (!isset($_POST['filter_submit'])) {
                ...
                $sql = "SELECT sk.*, GROUP_CONCAT(skp.filename) AS photos
                FROM staliniai_kompiuteriai sk
                LEFT JOIN staliniai_kompiuteriai_photos skp ON sk.id = skp.staliniai_kompiuteriai_id
                GROUP BY sk.id
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    foreach ($photos as $i => $photo) {
                        ...
                        $carousel_items .= '<div class="m-4"><img src="../crud/staliniai_kompiuteriai/uploads/' . $photo . '" class="d-block w-100 zoomable" alt="Product Image"></div>';
                        $carousel_items .= '</div>';
                    }
