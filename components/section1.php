                ...
                <div class="col-md-6">
                    <div class="card h-100 shadow rounded-0" style="background-image: url('assets/img/laptops.jpg'); background-size: cover; border: none;">
                        <div class="card-body cat" style="height: 285px;">
                            <a href="components/nesiojami.php" class="btn btn-primary-white" style="position:absolute; bottom:20px; right:20px; width:150px;">Nešiojami</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card h-100 shadow rounded-0" style="background-image: url('assets/img/pc.webp'); background-size: cover; border: none;">
                        <div class="card-body cat" style="height: 285px;">
                            <a href="components/staliniai.php" class="btn btn-primary-white" style="position:absolute; bottom:20px; left:20px; width:150px;">Staliniai</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-6">
                    <div class="card h-100 shadow rounded-0" style="background-image: url('assets/img/monitor.webp'); background-size: cover; border: none;">
                        <div class="card-body cat cat-bottom" style="height: 285px;">
                            <a href="components/monitoriai.php" class="btn btn-primary-white" style="position:absolute; top:20px; right:20px; width:150px;">Monitoriai</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card h-100 shadow rounded-0" style="background-image: url('assets/img/accessories.jpg'); background-size: cover; border: none;">
                        <div class="card-body cat cat-bottom" style="height: 285px;">
                            <a href="components/priedai.php" class="btn btn-primary-white" style="position:absolute; top:20px; left:20px; width:150px;">Priedai</a>
                        </div>
                    </div>
                </div>
            </div>
